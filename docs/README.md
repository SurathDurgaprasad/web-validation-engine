...
These three documents are a chronological record of how this project was actually built — not current architecture documentation. For how the project works today, see the [root README](../README.md).

They're kept because the process is itself part of what this project demonstrates: a real, messy starting point, a deliberate generalization effort, and an honest hardening pass that found and fixed real bugs by actually running the code instead of trusting that it worked.
